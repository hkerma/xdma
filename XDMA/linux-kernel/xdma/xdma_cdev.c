...
int xdma_cdev_init(void)
{
	...
	//This is where there might be an issue. Trying with 2 since I have only 2 DMA R/W channels (as recommended on https://github.com/Xilinx/dma_ip_drivers/issues/51 )
   	xdma_threads_create(2);
