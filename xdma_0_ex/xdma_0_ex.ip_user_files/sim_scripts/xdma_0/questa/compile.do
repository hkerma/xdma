...
vlib questa_lib/msim/xdma_v4_1_0

vmap xilinx_vip questa_lib/msim/xilinx_vip
vmap xil_defaultlib questa_lib/msim/xil_defaultlib
vmap xpm questa_lib/msim/xpm
vmap blk_mem_gen_v8_4_1 questa_lib/msim/blk_mem_gen_v8_4_1
vmap xdma_v4_1_0 questa_lib/msim/xdma_v4_1_0

vlog -work xilinx_vip -64 -sv -L xdma_v4_1_0 -L xil_defaultlib -L xilinx_vip "+incdir+../../../ipstatic/hdl/verilog" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -sv -L xdma_v4_1_0 -L xil_defaultlib -L xilinx_vip "+incdir+../../../ipstatic/hdl/verilog" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" "+incdir+../../../ipstatic/hdl/verilog" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 "+incdir+../../../ipstatic/hdl/verilog" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" "+incdir+../../../ipstatic/hdl/verilog" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
...
vlog -work blk_mem_gen_v8_4_1 -64 "+incdir+../../../ipstatic/hdl/verilog" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" "+incdir+../../../ipstatic/hdl/verilog" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
...
vlog -work xdma_v4_1_0 -64 -sv -L xdma_v4_1_0 -L xil_defaultlib -L xilinx_vip "+incdir+../../../ipstatic/hdl/verilog" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" "+incdir+../../../ipstatic/hdl/verilog" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
