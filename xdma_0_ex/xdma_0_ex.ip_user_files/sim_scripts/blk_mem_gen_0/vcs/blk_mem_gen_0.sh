...
#
# Generated by Vivado on Wed Jun 03 15:00:22 CEST 2020
...
# Design libraries
design_libs=(xilinx_vip xil_defaultlib xpm blk_mem_gen_v8_4_1)

# Simulation root library directory
sim_lib_dir="vcs_lib"

# Script info
echo -e "blk_mem_gen_0.sh - Script generated by export_simulation (Vivado v2018.1 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_1 $vlogan_opts +v2k +incdir+"/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
    "$ref_dir/../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a vlogan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
    "$ref_dir/../../../../xdma_0_ex.srcs/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
