...
vlog -work xilinx_vip -64 -sv -L xdma_v4_1_0 -L xil_defaultlib -L xilinx_vip "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -sv -L xdma_v4_1_0 -L xil_defaultlib -L xilinx_vip "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
...
vlog -work blk_mem_gen_v8_4_1 -64 "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" "+incdir+/opt/xilinx/Vivado/2018.1/data/xilinx_vip/include" \
